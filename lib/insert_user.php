...
<html lang="en">
  ...
  <body>
    ...
    <?php include_once 'navbar_seg.php'; ?>
    ...
    <div class="container pt-1 pb-3 mt-5 border">
      ...
      $_SESSION['new_user_type'] = 'studente';
      ...
      $_SESSION['new_user_type'] = 'docente';
    ...
    if ($_SESSION['new_user_type'] == 'docente') {
      $result = insert_teacher($_POST['nome_utente'], $_POST['password'], 'docente', $_POST['nome'], $_POST['cognome'], $_POST['e-mail']);
    } else {
      $result = insert_student($_POST['nome_utente'], $_POST['password'], 'studente', $_POST['cdl'],  $_POST['nome'], $_POST['cognome'], $_POST['e-mail']);
    }
